      ...
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white text-sm font-semibold rounded-md py-2.5 transition-colors"
          >
        ...
        <p className="text-xs text-gray-500 mt-6 text-center">
          Same login as your BOS account.
        </p>
      </div>
    </div>
  );
